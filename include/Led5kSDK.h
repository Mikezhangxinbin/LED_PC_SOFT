...
//广播通讯连接
LED5KSDK_API DWORD WINAPI CreateBroadCast(char *broad_ip,UINT broad_port,bx_5k_card_type card_type,int mode);
//固定IP通讯连接
...
// 网络搜索 
COMMAND_API BX5MK_WebSearch(DWORD dwHand,USHORT *Status, USHORT* Error ,char* IP ,char* SubNetMask,char* Gate,USHORT* Port ,char* Mac,char* NetID);
//  删除页数据
