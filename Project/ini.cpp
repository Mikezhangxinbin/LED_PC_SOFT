...
CString CIni::GetValue(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpDefault) 
{ 
	DWORD dValue; 
	TCHAR lpValue[MAX_PATH] ={0}; 
	
	dValue=GetPrivateProfileString(lpSection,lpKey,lpDefault,lpValue,MAX_PATH,m_strFileName); 
	return lpValue; 
} 
